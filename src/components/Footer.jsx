...
const App = () => {
  return (
    <div className="bg-[#0a2b70] text-white min-h-screen flex flex-col justify-between">
      {/* Top padding for even gap at the top */}
      ...
      {/* Footer Section */}
      <footer className="p-4 bg-[#c51f2c] text-white flex items-center justify-between">
